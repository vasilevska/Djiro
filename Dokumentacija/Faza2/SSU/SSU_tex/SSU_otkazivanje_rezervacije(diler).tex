...
\begin{document}
	...
	\begin{titlepage}  
		...
		{ \huge \bfseries Specifikacija scenarija upotrebe funkcionalnosti otkazivanje rezervacije } \\[5.5cm]
...
Đileri imaju pravo otkazivanja rezervacija vozača koje su prethodno odobrili. Uz
otkazivanje rezervacije se može priložiti poruka po želji.

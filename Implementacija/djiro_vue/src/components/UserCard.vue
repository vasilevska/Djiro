    ...
    <div class="card-body">
      <div class="d-flex flex-column align-items-center text-center">
        ...
        <div class="mt-3 text-center">
          ...
          <p class="text-secondary mb-1" v-if="user['is_djiler']">Điler</p>
          <p v-if="rating.count != 0">
            {{ rating.rating }} <font-awesome-icon icon="star" />
          </p>
          <p v-if="rating.count == 0">Ovaj korisnik jos uvek nema ocene</p>
        </div>
      </div>
    </div>
  </div>

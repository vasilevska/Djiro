  ...
  <div id="results" class="container pt-1 mt-2">
    <div class="row mt-2 pl-2">
      <div class="d-flex filteri mt-1">
        ...
        <h3>Filteri:&nbsp;&nbsp;</h3>
        <button
          class="btn btn-primary form-control pl-5"
          style="width: 200px"
          @click="filters()"
        >
          Filteri
    ...
    <div class="d-flex filteri mt-1 d-none py-3" id="filteri">
      ...
      <button class="btn btn-primary mx-2" style="width: 150px" @click="f2()">
        Filtriraj
      </button>
    </div>
    <hr />
...
export default {
  ...
  methods: {
    ...
    f2() {
      ...
      //ako su promenjena polja za filtriranje, pa mozda se neki auto vraca u cars
      for (i = 0; i < len; i++) {
        var tmp = 0;
        if (
          marka != "" &&

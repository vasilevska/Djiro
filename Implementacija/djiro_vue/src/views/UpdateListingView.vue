<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-sm-12">
        <div class="form-group my-3 mx-3">
            <label for="km">Kilometraža: </label><input type="number" min="0" max = "1000000" step="1" class="form-control" name="km" id="km" required>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div v-else>
      <class class="row justify-content-center align-items-center">
        <div class="col-auto"><ring-loader :color="color1" :height="height"></ring-loader></div>
      </class>
    </div>
  </div>
</template>
